...
class Enemigo1(pygame.sprite.Sprite):
    ...
    def __init__(self,dispararNum):
        ...
        sprite_sheet = SpriteSheet("knight.png")
        # Load all the right facing images into a list
...
class Objeto(pygame.sprite.Sprite):
    ...
    def __init__(self,sprite_sheet_data,nivel):
        ...
        pygame.sprite.Sprite.__init__(self)
        if nivel == 1:
            sprite_sheet = SpriteSheet("grass.png")
        if nivel==2:
            sprite_sheet = SpriteSheet("snow.png")
        if nivel == 3:
            sprite_sheet = SpriteSheet("night.png")
        if nivel == 4:
            sprite_sheet = SpriteSheet("castle.png")
